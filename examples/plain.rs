...
fn main() {
    let pts3 = [
        Point3::new(-0.429857595273321, -0.441798127281825, 0.714342354521372),
        Point3::new(-2.1568268264648, 0.113521604867983, -0.148634122716948),
        Point3::new(0.694636908485644, -0.737067927134015, -1.38877746946909),
        Point3::new(-1.07051455287146, -1.2122304801284, -0.841002964233812),
        Point3::new(0.509844073252947, -1.07097319594739, 0.675410167109412),
        Point3::new(0.40951585099, 2.2300713816052, 0.365229861025625),
        Point3::new(2.04320214188098, 1.11847674401846, 0.623432173763436),
    ];
    ...
    let solver = sqpnp::PnpSolver::new(&pts3, &pts2, vec![], SolverParameters::default());
